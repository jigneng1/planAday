...
class BookmarkPlanScreen extends StatefulWidget {
  ...
  const BookmarkPlanScreen({super.key, required this.onClose, required this.onViewPlan});
...
class _BookmarkPlanScreenState extends State<BookmarkPlanScreen> {
  ...
  void _loadBookmarks() async {
    final List<Map<String, dynamic>> savedPlans = await apiService.getBookmarkLists();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: const Text("Bookmarks Plan", style: TextStyle(fontWeight: FontWeight.bold),),
        leading: 
          IconButton(
